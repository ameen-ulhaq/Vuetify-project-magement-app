    ...
    <v-container class="my-5">
      ...
      <v-layout row class="mb-3 pa-3">
        ...
        <v-tooltip top>
          <template v-slot:activator="{ on, attrs }">
            <v-btn small text class="grey mr-3" @click="sortBy('title')" v-bind="attrs"
              v-on="on">
        ...
        <v-tooltip top>
          <template v-slot:activator="{ on, attrs }">
            <v-btn small text class="grey mr-3" @click="sortBy('person')"  v-bind="attrs"
              v-on="on">
              <v-icon left small>folder</v-icon>
      ...
      <v-card flat class="pa-3" v-for="project in projects" :key="project.title">
        <v-layout row wrap :class="`pa-3 project ${project.status}`"> 
          <v-flex xs12 md6>
            <div class="caption grey--text"> Project Tile </div>
